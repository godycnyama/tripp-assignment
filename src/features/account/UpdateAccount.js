...
import { updateAccount } from "../../state/slices/accountSlice";
          ...
          <div style={{ margin: 15 }}>
            ...
            {activeStep === 0 && (
              <form
                ...
                noValidate
              >
                <Typography variant="h6">Update Account Details</Typography>
                <Divider />
                <br />
            ...
            {activeStep === 1 && (
              <form onSubmit={createAccount} style={{ margin: 15 }} noValidate>
